...
def get_args():
    ...
    """
    parser.add_argument("--model_name", default="last_model_19.pkl", type=str, help="Model name to save and use")
    ###################################################
    ###################################################
...
class RCCarPolicy(Node):
    ...
    def train(self):
        ...
        best_model_path = os.path.join(self.model_dir, "best_model_19.pkl")
