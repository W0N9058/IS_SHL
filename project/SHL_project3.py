...
def get_args():
    ...
    """
    parser.add_argument("--model_name", default="last_model16.pkl", type=str, help="Model name to save and use")
    ###################################################
    ###################################################
...
class RCCarPolicy(Node):
    ...
    def train(self):
        ...
        # Load training data
        obs_data_path = os.path.join(self.traj_dir, "obs_map16.npy")
        act_data_path = os.path.join(self.traj_dir, "act_map16.npy")
        ...
        best_model_path = os.path.join(self.model_dir, "best_model16.pkl")
        ...
        np.save(os.path.join(self.model_dir, "obs_mean_16.npy"), self.obs_mean)
        np.save(os.path.join(self.model_dir, "obs_std_16.npy"), self.obs_std)
        np.save(os.path.join(self.model_dir, "act_mean_16.npy"), self.act_mean)
        np.save(os.path.join(self.model_dir, "act_std_16.npy"), self.act_std)
    ...
    def load(self):
        ...
        if self.mode == 'val':
            ...
            self.obs_mean = np.load(os.path.join(self.model_dir, "obs_mean_16.npy"))
            self.obs_std = np.load(os.path.join(self.model_dir, "obs_std_16.npy"))
            self.act_mean = np.load(os.path.join(self.model_dir, "act_mean_16.npy"))
            self.act_std = np.load(os.path.join(self.model_dir, "act_std_16.npy"))
